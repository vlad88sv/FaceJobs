...
class rejilla
{
    ...
    {
        $ret = '';
        $ret .= '<div style="text-align:left;margin:10px 0px;font-size:10px;color:grey;"><span style="font-size:14px;font-weight:bold;color:black;">1,000</span> resultados</span>, yey!. [<a href="#">Utilizar búsqueda guardada</a>] [<a href="#">Guardar búsqueda actual</a>] [<a href="#">Utilizar mi CV como base para la búsqueda</a>]</div>';
        return $ret;
    }
